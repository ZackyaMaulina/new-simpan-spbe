...
defined('BASE_URL')				OR define('BASE_URL', 'http://localhost/new-simpan-spbe/');
defined('ADMIN_ASSETS_URL')    	OR define('ADMIN_ASSETS_URL', BASE_URL . 'assets/');
defined('FRONTEND_URL')    	 	OR define('FRONTEND_URL', BASE_URL . 'application/view/frontend/');
