...
class Forums_Response extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $this->data['response'] = $this->forum_m->get_response();

        // printr($this->data['response']);
        // die();

        // Kirim data users ke view      
        $this->data['subview'] = 'admin/forum/forums_response';
    ...
    {
        $this->forum_m->delete_response($id);
        redirect('admin/forums_response');
