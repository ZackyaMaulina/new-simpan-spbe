                ...
                <div class="right-center">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <a class="dropdown-item" href="<?=base_url('admin/users/edit/' . $this->session->userdata['admin_user_id']); ?>"><i class="bi bi-person-gear"></i>Account Settings</a>
                            <a class="dropdown-item" href="<?=base_url('admin/users/logout') ?>"><i class="bi bi-box-arrow-right"></i>Logout</a>
                        </div>
                    </li>
                </div>
